    ...
    <div class="col-xs col-sm col-10 col-md-11 col-lg-9 col-xl-9 users-main delete-padding-left">
        <div class="ui-state-default user-list-info-box-add">
            <div class="admin-form col-xs col-sm col- col-md col-lg col-xl-8">
                ...
                @endif
                    <div class="alert alert-warning" role="alert" style="font-family: irs">
                        <h4 class="alert-heading">توجه !</h4>
                        <p> انتخاب تصویر برای ویرایش الزامیست</p>
                        <hr>
                    </div>
                <form class="needs-validation" enctype="multipart/form-data" id="main-form" novalidate action="/admin/edit/service/{{ $id }}" method="post">
                    @csrf
                    @foreach($service as $item)
                        <div id="row">
                            ...
                            <div class="form-group col-xs col-sm col- col-md col-lg col-xl-12">
                                ...
                                <input type="text" value="{{ $item['title'] }}" name="title[]" class="form-control" id="inputname" placeholder="عنوان سایت را وارد کنید">
                            </div>
                            <div class="form-group col-xs col-sm col- col-md col-lg col-xl-12">
                                <label for="inputEmail4"> توضیحات  خدمات</label>
                                <textarea name="description[]" class="form-control" id="validationTextarea" placeholder="توضیحات مربوط به مخدمات را وارد کنید..." required="">
                                    {{ $item['description'] }}
                                </textarea>
